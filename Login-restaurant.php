        ...
        <div class="container">
            <div class="row">
                <div class="form-reservations-box">
                    ...
                    <h4><a class="text-center" href="Login-customers.php">Login as Customer here</a></h4>
                        </div>
              <!--           <h4 class="form-title">BOOKING FORM</h4>
                        <p>PLEASE FILL OUT ALL REQUIRED* FIELDS. THANKS!</p> -->

                        <form method="post" class="reservations-box" action="Login-restaurant.php">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-box">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-box">
                                    <input type="email" name="email" id="email" placeholder="E-mail Id" required="required" data-error="Restaurant E-mail Id is required.">
                                </div>
                            </div>
                            <!-- end col -->
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
